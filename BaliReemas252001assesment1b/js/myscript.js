...
function show()
{
    ...
    else if(document.getElementById('ftr').checked == true)
    {
...
// buttons to choose font size
    ...
    if(document.getElementById('fsm').checked == true)
    {
        document.body.style.fontSize = "small";
        fontsize = "fsm";
            }
    else if(document.getElementById('fmd').checked == true)
    {
        document.body.style.fontSize = "medium";
        fontsize = "fmd";
    }
    else if(document.getElementById('flr').checked == true)
    {
...
// buttons to choose font colour
    ...
    if(document.getElementById('fc1').checked == true)
    {
        document.body.style.color ="black";
        fontcolor ="fc1";
    }
    else if(document.getElementById('fc2').checked == true)
    {
        document.body.style.color ="red";
        fontcolor ="fc2";
    }
    else if(document.getElementById('fc3').checked == true)
    {
        document.body.style.color ="green";
        fontcolor="fc3";
    }
    else if(document.getElementById('fc4').checked == true)
    {
        document.body.style.color ="blue";
        fontcolor="fc4";
    }
    else if(document.getElementById('fc5').checked == true)
    {
...
// buttons to choose background colours
    ...
    else if(document.getElementById('bc2').checked == true)
    {
        document.body.style.background ="red";
        background="bc2";
    }
    else if(document.getElementById('bc3').checked == true)
    {
        document.body.style.background ="green";
        background="bc3";
    }
    else if(document.getElementById('bc4').checked == true)
    {
        document.body.style.background ="blue";
        background="bc4";
    }
    else if(document.getElementById('bc5').checked == true)
    {
...
function storeText()
{
    ...
    if (window.localStorage!==undefined) {
        ...
        var a = localStorage.getItem("font");
    }
...
window.onload = function()
{
    ...
    if (localStorage.length > 0 ){
        var fo = localStorage.getItem("font");
        var fs = localStorage.getItem("fontSize");
        var fc = localStorage.getItem("fontColor");
